...
<a href="events/create" class="btn btn-primary btn-sm align-right">Novo Produto</a>
@if(count($events) > 0) 
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/events/{{ $event->id }}" class="btn btn-primary btn-sm">Ver</a>
                        <a href="/events/edit/{{ $event->id }}" class="btn btn-secondary btn-sm">Editar</a>
                    </div>
                </div>
            </div>
            @endforeach
